								        			...
								        			?>
									          		<tr>
											            ...
											            <td class="text-center td-actions">
												            <a rel="tooltip" href=".php?editrole=<?php echo $role['proj_id']; ?>" class="btn btn-success btn-link" title="Edit">
												              <i class="material-icons">edit</i>
												            </a>
												        </td><td>
												            <a rel="tooltip" href="process/admin/usr_process.php?delrole=<?php echo $role['proj_id']; ?>" class="btn btn-danger btn-link" title="Delete">
