...
if(isset($_POST['printOPD']) || isset($_GET['id']) || isset($_POST['editOPD'])){
  ...
  //$pdf->Cell(18,5,"$qty",0,0,'C',0);
      ...
      $slno++;
      if($insert){
        $query3 = "INSERT INTO `invoice`(`pid`, `billno`, `pname`, `ddate`, `desc`, `qty`, `price`, `subt`, `total`, `collby`, `paymode`, `cqno`) VALUES ('".$opd."','".$r."','".$name."','".$dat."','".$desc."','".$qty."','".$price."','".$total."','".$price."','".$cb."','".$pm."','".$cqno."')";
